...
def get_next_file_number(number_file_folder, input_folder):
    ...
    with open(number_file_path, 'w') as number_file:
        next_file_number = (current_file_number % file_count) + 1
...
current_file_number = get_next_file_number(number_file_folder_path, input_folder_path)
