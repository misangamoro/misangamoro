...
def generate_json(folder_path):
    ...
    visuals_production_path = r"C:\Users\Sumit\Desktop\Online\Visuals Production\Assest\Image\Charectes"
    ...
    for file_name in files:
        if file_name.endswith(".txt"):
            ...
            full_image_path = os.path.join(visuals_production_path, f"{image_name}.png")
