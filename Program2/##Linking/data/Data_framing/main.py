...
# Function to create text files for each conversation with a unique number
def create_text_files(file_path, output_folder):
    ...
    for line in lines:
        if line.strip():  # Skip empty lines
            ...
            file_name = os.path.join(output_folder, f"{conversation_order}_{sanitized_name}.txt")
...
create_text_files(r'C:\Users\Sumit\Desktop\Online\Visuals Production\Program2\#clips_control\#Input_reading\out\input.txt', r'C:\Users\Sumit\Desktop\Online\Visuals Production\Program2\##Linking\data\Data_framing\out')
