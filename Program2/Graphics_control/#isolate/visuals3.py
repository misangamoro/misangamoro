...
# ...
    ...
    # Generate additional frames for the static period with "hello" text on top of the input image
    ...
    for i in range(text_frames):
        ...
        x_text, y_text = 675, 350

        # Adjust the position of the text using the specific coordinates
        text_position = (x_text, y_text)
        draw.text(text_position, "hello", font=font, fill=font_color)
