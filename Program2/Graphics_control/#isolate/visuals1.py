...
def create_video(image_path, output_video_path, background_video_path, duration_sec=5, wait_sec=5, fps=60, height=1080, width=1920):
...
if __name__ == "__main__":
    ...
    # Create the video
    create_video(input_image_path, output_video_path, background_video_path, resize_duration, wait_duration, video_fps, video_height, video_width)
