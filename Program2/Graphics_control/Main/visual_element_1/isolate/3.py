...
def create_animation(image_path, text1, text2, delay_text_duration, writer, background_reader, rest_duration=5, text_display_duration=5, transition_duration=0.5, fps=60, height=1080, width=1920):
...
def main():
    ...
    create_animation(image_path_1, text_1_1, text_2_1, delay_text_duration_1, writer, background_reader)
    ...
    create_animation(image_path_2, text_1_2, text_2_2, delay_text_duration_2, writer, background_reader)
