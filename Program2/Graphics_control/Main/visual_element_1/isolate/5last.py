...
def create_animation(image_path, text1, text2, delay_text_duration, text_display_duration, writer, background_reader, resize_duration=0.5, transition_duration=0.5, fps=60, height=1080, width=1920):
...
def main():
    ...
    text_display_duration_1 = 3  # Set your desired text_display_duration for Animation 1

    create_animation(
        image_path_1, text_1_1, text_2_1, delay_text_duration_1, text_display_duration_1,
        writer, background_reader, resize_duration=0.5
    )
    ...
    delay_text_duration_2 = 1
    text_display_duration_2 = 2  # Set your desired text_display_duration for Animation 2

    create_animation(
        image_path_2, text_1_2, text_2_2, delay_text_duration_2, text_display_duration_2,
        writer, background_reader, resize_duration=0.5
    )
